...
<html lang="en">
  ...
  <body class="bg-light">
          ...
          <div class="card shadow my-4">  
            ...
            <div class="">
                        ...
                        if(mysqli_num_rows($result) > 0){
                            ...
                            while($row = mysqli_fetch_array($result)){
                                ...
                                echo "<tr  ". $row ['id'].">";
                                    ...
                                    echo "<script>console.log('".$row ['name']."-".$row ['password']."')</script>";
                                    // echo "<td id='td". $row ['password']."'>" . $row['password'] . "</td>";
                                    ?>
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                      ...
                                      <li><a id='<?php echo $row ['id']; ?>' class="dropdown-item" data-bs-toggle="modal" data-bs-target="#exampleModal" onClick="myFunction('<?php echo $row ['id']; ?>','<?php echo $row ['name']; ?>')" href="#">Update</a></li>
              ...
              <div class="card-footer px-4 py-3">
                <span><i class="bi bi-person-plus-fill me-2"></i></i></span>Add, <?php echo $_SESSION['current_table']?>
    ...
    <script type="text/javascript">
      ...
      function myFunction(elementId,elementName) {
        console.log("update.php?id=" + elementId + "&name=" + elementName);
        var id = elementId;
