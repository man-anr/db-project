<?php 
  ...
  $_SESSION['current_table'] = "student";
...
<html lang="en">
  ...
  <body class="bg-light">
                      ...
                      <div class="modal-body">
                        ...
                        <form class="" id="updateform" name="updateform"  method = "POST" novalidate="" autocomplete="off">
                            ...
                            <div class="input-group p-3">
                              ...
                              <input name="updateemail" type="name" class="form-control" id="updateemail" placeholder="">
                            </div>
                  ...
                  <?php
                    ...
                    if($result = mysqli_query($con, $sql)){
                        if(mysqli_num_rows($result) >= 0){
                            echo "<table id='example' class='table table-border table-hover data-table'>";
                            echo "<thead class=''>";
                                echo "<tr>";
                                    echo "<th scope='col' >ID</th>";
                                    echo "<th scope='col' >Name</th>";
                                    echo "<th scope='col' >Email</th>";
                                    echo "<th scope='col' >Modifed By</th>";
                                    echo "<th scope='col' >Modifed On</th>";
                            ...
                            while($row = mysqli_fetch_array($result)){
                                ...
                                echo "<tr  ". $row ['id'].">";
                                    ...
                                    echo "<td id='td". $row ['email']."'>" . $row['email'] . "</td>";
                                    ...
                                    <a class="btn btn-light dropdown float-right" href="#" role="button" id="studentDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="studentDropdown">
                                      ...
                                      <li><a id='<?php echo $row ['id']; ?>' class="dropdown-item"  data-bs-toggle="modal" data-bs-target="#exampleModal" onClick="myFunction('<?php echo $row ['id']; ?>','<?php echo $row ['name']; ?>', '<?php echo $row ['email']; ?>')" href="#">Update</a></li>
              ...
              <div class="card-footer px-4 py-3">
                ...
                <table style="width:100%" class="p-1 mt-2">
                    ...
                    <form class="row row-cols-lg-auto g-3 " name="login" action = "add.php" method = "POST">
                      ...
                      <td>
                        <div class="input-group ">
                          <input name="email" type="email" class="form-control" id="exampleDropdownFormPassword1" placeholder="e-mail is auto-assigned" disabled>
                        </div>
                      </td>
                      <td>
    ...
    function myFunction(elementId,elementName,elementEmail) {
      console.log("update.php?id=" + elementId + "&name=" + elementName +  "&email=" + elementEmail);
      var id = elementId;
      var name = elementName;
      var email = elementEmail;
      var action = "update.php?id=" + elementId + "&name=" + elementName + "&email=" + elementEmail;
      ...
      document.getElementById("updateemail").placeholder = email;
